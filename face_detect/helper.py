# source of the code: https://raw.githubusercontent.com/slobdell/facebook_face_training_set/master/create_pics_from_facebook.py
#article explaining the code: http://scottlobdell.me/2014/01/facial-recognition-in-python/
